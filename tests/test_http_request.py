...
class RequestTest(unittest.TestCase):
    ...
    def test_url_encoding_query(self):
        ...
        r2 = self.request_class(url="http://www.scrapy.org/price/£?unit=µ",
                                encoding="utf-8")
    ...
    def test_url_encoding_query_latin1(self):
        ...
        r3 = self.request_class(url="http://www.scrapy.org/price/µ?currency=£",
                                encoding="latin1")
    ...
    def test_body(self):
        ...
        r3 = self.request_class(url="http://www.example.com/",
                                body="Price: \xa3100",
                                encoding="utf-8")
        assert isinstance(r3.body, bytes)
        self.assertEqual(r3.body, b"Price: \xc2\xa3100")

        r4 = self.request_class(url="http://www.example.com/",
                                body="Price: \xa3100",
                                encoding="latin1")
    ...
    def test_from_curl_with_kwargs(self):
        r = self.request_class.from_curl('curl -X PATCH "http://example.org"',
                                         method="POST",
                                         meta={"key": "value"})
        self.assertEqual(r.method, "POST")
...
class FormRequestTest(RequestTest):
    ...
    def test_from_response_duplicate_form_key(self):
        response = _buildresponse("<form></form>",
...
class JsonRequestTest(RequestTest):
    ...
    def test_body_data(self):
        ...
        with warnings.catch_warnings(record=True) as _warnings:
            r5 = self.request_class(url="http://www.example.com/",
                                    body=body,
                                    data=data)
    ...
    def test_empty_body_data(self):
        ...
        with warnings.catch_warnings(record=True) as _warnings:
            r6 = self.request_class(url="http://www.example.com/",
                                    body=b"",
                                    data=data)
    ...
    def test_body_none_data(self):
        ...
        with warnings.catch_warnings(record=True) as _warnings:
            r7 = self.request_class(url="http://www.example.com/",
                                    body=None,
                                    data=data)
    ...
    def test_body_data_none(self):
        with warnings.catch_warnings(record=True) as _warnings:
            r8 = self.request_class(url="http://www.example.com/",
                                    body=None,
                                    data=None)
